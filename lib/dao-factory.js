...
module.exports = (function() {
  ...
  DAOFactory.prototype.build = function(values, options) {
    options = options || {}
    var isNew    = options.hasOwnProperty('isNewRecord') ? options.isNewRecord : true
			, instance = new DAO(values, Utils._.extend(this.options, this.attributes, { hasPrimaryKeys: this.hasPrimaryKeys, 'isNew': isNew }))
      , self     = this

    
		instance.isNewRecord = isNew
