...
module.exports = (function() {
  var DAO = function(values, options) {
    ...
    this.__dirty = {} // keep track of dirty attribute
    this.__comitted = {} // keep track of dirty attribute
  ...
  Object.defineProperty(DAO.prototype, 'changes', {
    get: function() {
      return this.__dirty;
    }
  })
	
	Object.defineProperty(DAO.prototype, 'changed', {
    get: function() {
      return this.__committed || {};
    }
  })
  ...
  DAO.prototype.save = function(fields) {
    ...
    if(this.__options.timestamps && this.hasOwnProperty(updatedAtAttr)) {
      ...
      values[updatedAtAttr] = now
		...
		this.__committed = Utils._.clone(this.__dirty);
		this.__dirty = {};
  ...
  DAO.prototype.addAttribute = function(attribute, value, skipDirty) {
    this[attribute] = value
		if(!skipDirty && value != null) {
			this.__dirty[attribute] = {old: null, current: value};
		}
  ...
  var initAttributes = function(values) {
    ...
    Utils._.map(values, function(value, key) { self.addAttribute(key, value, {initialLoad: true}) })
